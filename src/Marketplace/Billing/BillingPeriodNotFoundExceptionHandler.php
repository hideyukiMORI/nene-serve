...
final readonly class BillingPeriodNotFoundExceptionHandler implements DomainExceptionHandlerInterface
{
    ...
    {
        return $exception instanceof BillingPeriodNotFoundException;
    }
