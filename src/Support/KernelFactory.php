...
final class KernelFactory
{
    ...
    public static function database(PDO $pdo, string $storageDir, callable $read): Kernel
    {
        ...
        return new Kernel(
            ...
            serviceTokens: new PdoServiceTokenRepository($query),
            audit: new PdoAuditLog($query),
            events: new PdoEventStore($query),
            frequencyCaps: new FileFrequencyCapStore($storageDir . '/frequency.json'),
            tx: new PdoTransactionManager($pdo),
            advertisers: new PdoAdvertiserRepository($query),
            pricingRules: new PdoPricingRuleRepository($query),
            ...
            changePlans: new PdoChangePlanRepository($query),
