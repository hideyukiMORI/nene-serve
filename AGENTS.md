...
per ADR 0011, `openapi-typescript` codegen). Dev port **5180**, Storybook **6107**; backend
proxied from `APP_PORT` (8010). Quality gate: `npm run check`. See `frontend/README.md`.
