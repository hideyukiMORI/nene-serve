...
/** Spanish catalog (ADR 0011; non-authority — Frontend Standard 04, I18N-9). */
export const es = {
  ...
  'settings.tenant.title': 'Resolución de organización',
  'settings.tenant.mode': 'Modo',
  'settings.tenant.organization': 'Organización',
  'settings.tenant.note': 'Se define en la configuración de despliegue (TENANT_RESOLUTION).',
